...
class TrafficModel(mesa.Model):
    ...
    def __init__(self, width: int = 20, height: int = 20, num_cars_east: int = 8,
                 num_cars_north: int = 8, smart_lights: bool = False):
        super().__init__()
        ...
        controller = IntersectionController(self, smart=smart_lights,
                                            lights=[light_east, light_north], sensor_range=6)
